...
export const NoApiKeyTextMessage = () => {
  return (
    <div className='no-api-key'>
      <p className='no-api-key-subtitle'>
        Please, go to
        <CustomLink
          type='external'
          content={
      ...
      <ul className='no-api-key-description-list'>
        ...
        <li className='no-api-key-description-list-item'>
          Confirm your email and return to NEWSDATA.IO.
        </li>
        <li className='no-api-key-description-list-item'>
        ...
        <li className='no-api-key-description-list-item'>
          Chose tab "API Key" and copy your API key (it should looks like
          pub_7326b2c6fa87e39fae652402g354001d0bq8).
        </li>
        <li className='no-api-key-description'>
          Now, please paste your API key into the field below and you will get
          hot news in a few seconds.
        </li>
      </ul>
    </div>
  );
